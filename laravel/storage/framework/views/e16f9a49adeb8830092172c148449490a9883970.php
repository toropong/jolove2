    ...
    <body>
        ...
        <div class="container px-4 px-lg-5" style="width: 100%; height:100%;">
            ...
            <?php $__currentLoopData = $product; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $products): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="col-lg-7"><img class="img-fluid rounded mb-4 mb-lg-0" src="\storage\app\public\<?php echo e($products['filename']); ?>" width="200" height="200" style="border-style: solid" onerror="this.style.display='none'" /></div>
                <div class="col-lg-5">
...
<td> <input id="likebtn" type="button" value="♥" /><input id = "count"  style="pointer-events: none" value="<?php echo e($likes); ?>"></td>
            ...
            <form class="form-horizontal" method="POST"  role="form" name="frm_custom" id="frm_custom"  enctype="multipart/form-data">
              ...
              <input type="hidden" name="no" id="no" value="<?php echo e($comments['w_no']); ?>"> 
              <input type="hidden" name="c_no" id="c_no" value="<?php echo e($comments['c_no']); ?>"> 
                 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              <div class="combox">
                    ...
                    <div class="neadcomt">
                      <div class="comment_naeyoung">
                        <div class="comment_people">
                          ...
                          <?php echo e($comments['u_no']); ?>

                        </div>
                        <div class="value_comment">
                          <p> <?php echo e($comments['c_comments']); ?></p>
                        </div>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\jolove2\laravel\resources\views/product.blade.php ENDPATH**/ ?>